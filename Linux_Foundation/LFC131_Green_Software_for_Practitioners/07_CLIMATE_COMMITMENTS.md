...
![Climate Commitments principle](images/climate_commitments_principle.png)
...
### 2.1 Carbon Reduction Methodologies
...
![Carbon Reduction Methodologies](images/carbon_reduction_methodologies.png)
...
![Climate COmmitments Strategies](images/climate_commitments_strategies.png)
...
![100% Renewable](images/100_precent_renewable.png)
...
To solve this problem, a renewable plant sells two things. The first is its electricity, which it sells into a grid. The second is a REC, a [Renewable Energy Certificate](https://www.epa.gov/green-power-markets/renewable-energy-certificates-recs). 1 REC equals 1kWh of energy.
...
![Daily vs Hourly Matching](images/daily_hourly_matching.png)
...
![Daily vs Hourly Matching (2)](images/daily_hourly_matching_2.png)
...
![Carbon Aware Computing](images/carbon_aware_computing.png)

![Carbon Aware Computing Tip](images/carbon_aware_computing_tip.png)
