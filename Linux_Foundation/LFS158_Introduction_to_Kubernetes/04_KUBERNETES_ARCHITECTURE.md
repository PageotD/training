...
<p style="text-align: center;"><em>Components of a Kubernetes cluster</em></p>

## 2.2 Control Plane Node Overview
...
### 2.2 Control Plane Node Components
...
![kubeadm HA topology](images/kubeadm_ha_topology.png)
<p style="text-align:center;"><em>kubeadm HA topology - Stacked etcd topology</em></p>

For data store isolation from the control plane components, the bootstrapping process can be configured for an external etcd topology, where the data store is provisioned on a dedicated separate host, thus reducing the chances of an etcd failure.

![external etcd topology](images/external_etcd_topology.png)
<p style="text-align:center;"><em>kubeadm HA topology - External etcd topology</em></p>
...
![Leader and Followers](images/leader_and_followers.png)
<p style="text-align:center;"><em>Leader and followers</em></p>

### 2.3 Worker Node Overview
...
- **[CRI-O](https://cri-o.io/)** - A lightweight container runtime for Kubernetes, supporting quay.io and Docker Hub image registries.
- **[containerd](https://containerd.io/)** - A simple, robust, and portable container runtime.
- **[Docker Engine](https://www.docker.com/)** - A popular and complex container platform which uses containerd as a container runtime.
...
![Container Runtime Interface](images/container_runtime_interface.png)
<p style="text-align:center;"><em>Container Runtime Interface</em></p>
...
#### 2.5.1 Container-to-Container communication inside Pods
...
#### 2.5.2 Pod-to-Pod communication across nodes
...
![Container Network Interface Core Plugins](images/container_network_interface_core_plugins.png)
...
#### 2.5.3 External-to-Pod communication
